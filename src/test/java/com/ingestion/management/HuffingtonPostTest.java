...
public class HuffingtonPostTest {
    ...
    public void shouldScrapWithoutErrors() {
        assertThatCode(() -> huffingtonPost.scrapMainPage()).doesNotThrowAnyException();
    }

    @Test
    public void scrapWithoutErrorsPageContent() {
        assertThatCode(() -> huffingtonPost.scrapPageContent("https://www.huffpost.com/entry/fda-approves-pfizer-vaccine-12-to-15-year-olds_n_6070be53c5b6616dcd780ef5")).doesNotThrowAnyException();
    }
}
